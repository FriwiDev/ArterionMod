...
public class FriendlyPlayerList {
	...
	public static void setEntry(UUID uuid, FriendlyPlayerEntry ent) {
		if (Minecraft.func_71410_x().func_110432_I() != null 
				&& Minecraft.func_71410_x().func_110432_I().func_148256_e() != null
				&& Minecraft.func_71410_x().func_110432_I().func_148256_e().getId() != null
				&& Minecraft.func_71410_x().func_110432_I().func_148256_e().getId().equals(uuid))
			return;
